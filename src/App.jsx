...
function App() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl mx-auto flex bg-white/30 backdrop-blur-sm rounded-lg overflow-hidden border border-gray-300 shadow-lg">
        {/* Left Side - Chai Image */}
